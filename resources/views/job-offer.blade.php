...
<!-- Mirrored from htmlstream.com/preview/front-v4.3.1/portfolio-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jun 2024 14:09:32 GMT -->
<head>
              ...
              <div class="hs-mega-menu dropdown-menu w-100" aria-labelledby="demosMegaMenu" style="min-width: 40rem;">
                ...
                <div class="navbar-dropdown-menu-promo">
                  ...
                  <div class="navbar-dropdown-menu-promo-item">
                    <!-- Promo Link -->
                    <a class="navbar-dropdown-menu-promo-link active" href="index-2.html">
                      <div class="d-flex">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <div class="navbar-absolute-top-scroller">
            <ul class="navbar-nav">
              ...
              <!-- Portfolio -->
              <li class="hs-has-sub-menu nav-item">
                <a id="portfolioMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle active" href="#" role="button" aria-expanded="false">Portfolio</a>
    ...
    <div class="container content-space-b-2 content-space-b-lg-3">
      ...
      <div class="js-shuffle row row-cols-1 row-cols-sm-2 row-cols-md-3">
        ...
        <div class="js-shuffle-item col mb-5" data-groups='["product"]'>
          <!-- Card -->
          <a class="card card-flush card-transition" href="{{route('show',$job->id)}}">
            <img class="card-img-top" src="assets/img/400x500/img12.jpg" alt="Image Description">
            <div class="card-body">
              <span class="card-subtitle text-body">{{$job->title}}</span>
              <h3 class="card-title">{{$job->location}}</h3>
            </div>
...
<!-- Mirrored from htmlstream.com/preview/front-v4.3.1/portfolio-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jun 2024 14:09:34 GMT -->
</html>